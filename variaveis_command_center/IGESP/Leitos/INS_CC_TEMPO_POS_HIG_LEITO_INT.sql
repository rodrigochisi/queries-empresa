...
-- Verifica e remove a view se já existir
   EXECUTE IMMEDIATE 'DROP VIEW  INVISUAL.INS_CC_TEMPO_POS_HIG_LEITO_INT';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
-- ======================================================================================
-- NOME DA DA VIEW: INS_CC_TEMPO_POS_HIG_LEITO_INT
-- VARIÁVEL COMMAND CENTER: Leitos - Paciente em Leito Extra
-- PROPÓSITO: Monitora o tempo de pos higienizacao de leito - UTI / UI - Apartamento
-- CRIADO POR: Rubens
-- DATA DE CRIAÇÃO: **
