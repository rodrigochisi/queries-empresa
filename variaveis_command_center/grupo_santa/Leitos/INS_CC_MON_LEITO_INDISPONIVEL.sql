...
\f0\fs24 \cf0 -- ======================================================================================\
-- VIEW: INS_CC_MON_LEITO_INDISPONIVEL\
-- PROP\'d3SITO: Monitora leitos indispon\'edvel por tipo de ocupa\'e7\'e3o - Reservado / Manuten\'e7\'e3o\
-- CRIADO POR:  Rodrigo \
...
\
\
 CREATE OR REPLACE FORCE EDITIONABLE VIEW "INVISUAL"."INS_CC_MON_LEITO_INDISPONIVEL"  AS\
 \
 \
  SELECT  \
