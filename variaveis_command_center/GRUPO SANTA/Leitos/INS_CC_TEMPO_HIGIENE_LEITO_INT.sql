...
{\*\expandedcolortbl;;}
\paperw11900\paperh16840\margl1440\margr1440\vieww12480\viewh8460\viewkind0
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\partightenfactor0

\f0\fs24 \cf0 -- ======================================================================================\
-- VIEW: INS_CC_TEMPO_HIGIENE_LEITO_INT\
-- PROP\'d3SITO: Monitora o tempo de higieniza\'e7\'e3o do leito\
-- CRIADO POR:  Rubens\
...
\
\
 CREATE OR REPLACE FORCE EDITIONABLE VIEW "INVISUAL"."INS_CC_TEMPO_HIGIENE_LEITO_INT"  AS\
\
 select \
...
case when leito.DS_LEITO like '%UTI%'  then  'UTI'   -- UTI\
     else  'UI'     -- UI\
                  END TIPOACOMODACAO , \
